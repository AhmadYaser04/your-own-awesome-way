...
const AR: Dict = {
  ...
  "home.subtagline": "من ميثاق الجامعة المُحوَّل منها إلى ميثاق جامعة العقبة للتكنولوجيا — لتخصص الذكاء الاصطناعي حصراً",
  ...
  "home.step1.d": "ألصق نصاً أو ارفع ملف PDF أو صورة من الهاتف لوصف المادة من ميثاق الجامعة المُحوَّل منها.",
  ...
  "home.collegeDesc": "هذا النظام مخصص حصراً لمعادلة مواد طلاب علم الحاسوب/الذكاء الاصطناعي المنتقلين من جامعات أو كليات أو دبلومات أخرى إلى خطة البكالوريوس في الذكاء الاصطناعي بكلية تكنولوجيا المعلومات في جامعة العقبة للتكنولوجيا (تأسس البرنامج عام 2019).",
  ...
  "eq.subtitle": "من ميثاق الجامعة المُحوَّل منها إلى ميثاق جامعة العقبة للتكنولوجيا",
  "eq.tab.text": "نص",
  "eq.tab.pdf": "ملف PDF",
  "eq.tab.image": "صورة",
  "eq.text.label": "الصق وصف المادة من ميثاق الجامعة المُحوَّل منها",
  ...
  "eq.pdf.label": "ارفع ملف PDF لوصف المادة (حتى 50MB)",
  ...
  "college.planSub": "مواد تخصص الذكاء الاصطناعي المعتمدة لاستخدامها كمرجع في معادلة المواد المنتقلة",
  ...
  "about.subtitle": "نظام معادلة المواد الذكي — حلٌّ مدعوم بالذكاء الاصطناعي لمعادلة المواد الدراسية بين الجامعات والكليات والدبلومات وجامعة العقبة للتكنولوجيا في تخصص الذكاء الاصطناعي.",
  ...
  "auth.saudiUni": "الجامعة المُحوَّل منها",
  "auth.saudiUniPh": "اسم الجامعة/الكلية السابقة",
  ...
  "admin.topUnis": "أكثر الجامعات تقديماً",
...
const EN: Dict = {
  ...
  "home.subtagline": "From your previous university's charter to AUT's charter — exclusively for the AI specialization",
  ...
  "home.step1.d": "Paste text or upload a PDF or a photo of the course description from your previous university's charter.",
  ...
  "home.collegeDesc": "This system is exclusively dedicated to mapping CS/AI courses from previous universities, colleges, and diplomas to AUT's BSc program in Artificial Intelligence at the Faculty of Information Technology (program founded in 2019).",
  ...
  "eq.subtitle": "From your previous university's charter to AUT's charter",
  "eq.tab.text": "Text",
  "eq.tab.pdf": "PDF File",
  "eq.tab.image": "Image",
  "eq.text.label": "Paste the course description from the previous university's charter",
  ...
  "eq.pdf.label": "Upload a PDF of the course description (up to 50MB)",
  ...
  "college.planSub": "AI specialization courses used as the reference for equivalency of transferred credentials",
  ...
  "about.subtitle": "AI Course Equivalency System — an AI-powered solution for mapping courses between previous universities, colleges, and diplomas and Aqaba University of Technology in the AI specialization.",
  ...
  "auth.saudiUni": "Previous University",
  "auth.saudiUniPh": "Previous university/college name",
  ...
  "admin.saudiDesc": "Transferred Course Description",
  ...
  "admin.topUnis": "Top previous universities",
