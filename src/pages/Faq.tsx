...
const CATEGORIES = [
  {
    ...
    questions: [
      ...
      },
      {
        ...
        a: "بشكل أساسي للطلاب المنتقلين من جامعات أو كليات أو دبلومات أخرى الذين يدرسون علم الحاسوب أو الذكاء الاصطناعي ويرغبون بالتحويل إلى جامعة العقبة للتكنولوجيا. كذلك مفيد للمرشدين الأكاديميين ولأولياء الأمور لأخذ فكرة مبدئية قبل بدء إجراءات التحويل الرسمية.",
      },
      {
  ...
  },
  {
    ...
    questions: [
      {
        q: "كيف يساعدني الموقع إذا كنت طالباً منتقلاً من جامعة أو كلية أخرى؟",
