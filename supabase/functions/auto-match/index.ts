...
الوصف الرسمي: ${c.description_ar || "(لا يوجد وصف رسمي — استنتج المحتوى من الاسم والكود ومن معرفتك بالخطط الأكاديمية المماثلة)"}`
    ...
    const systemPrompt = `أنت خبير أكاديمي متخصص في معادلة المساقات الجامعية بين الجامعات والكليات والدبلومات وجامعة العقبة للتكنولوجيا (AUT) — تخصص الذكاء الاصطناعي.
...
- استنتج محتوى مواد الطالب بناءً على:
  1. اسم المادة + كودها + معرفتك بالمناهج المعتادة في الجامعات والكليات لتخصصات الحاسوب والذكاء الاصطناعي وعلم البيانات.
